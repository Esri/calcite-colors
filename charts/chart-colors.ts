...
export const OtherColor: string = ColorPalette[26];

export const DefaultColors: string[] = [
  ...ColorPalette.slice(30, 39),
  ...ColorPalette.slice(28, 30).reverse(),
];
...
export const ChartColors: { palette: string[]; sets: ColorSet[] } = {
  palette: ColorPalette,
  sets: ColorSets,
};

export function colorFromColorSet(
  index: number,
  colorSet: ColorSet = ColorSets[0]
): string {
